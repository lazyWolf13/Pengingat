...
<div class="container-fluid px-4 py-5">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-6 text-white">
        <h2 class="text-2xl font-bold mb-2">
            <i class="fas fa-user-plus mr-2"></i>Tambah Profil Baru
        </h2>
        <p class="opacity-80">Lengkapi informasi di bawah untuk menambahkan profil baru ke sistem</p>
    </div>

    <!-- Form Card dengan Grid Layout -->
    <div class="card shadow-xl border-0 rounded-xl">
        <div class="card-body p-6">
            <form action="{{ route('admin.profilescreate.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="isi" 
                                  ...
                                  placeholder="Masukkan isi" required>{{ old('isi') }}</textarea>
                        @error('isi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
