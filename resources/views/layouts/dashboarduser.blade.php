...
<body class="bg-gradient-to-br from-green-100 via-green-200 to-green-300 min-h-screen">
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-gradient-to-t from-green-300 to-green-200 text-gray-900 p-6 fixed top-0 left-0 h-screen shadow-lg overflow-y-auto">
            ...
            <nav class="space-y-4">
                ...
                <a href="attendance" class="block py-2 px-4 text-green-700 rounded-lg hover:bg-green-300">
                    📍 Absen Harian
                </a>
                <a href="attendance_history" class="block py-2 px-4 text-green-700 rounded-lg hover:bg-green-300">
                    📅 Riwayat Absensi
                </a>

                <!-- Tugas Section -->
                <h3 class="text-gray-600 uppercase text-xs font-bold">Tugas</h3>
                <a href="my_tasks" class="block py-2 px-4 text-green-700 rounded-lg hover:bg-green-300">
                    ✅ Tugas Saya
                </a>
                ...
                <a href="documents" class="block py-2 px-4 text-green-700 rounded-lg hover:bg-green-300">
                    📁 Dokumen Saya
                </a>
                ...
                <a href="profile" class="block py-2 px-4 text-green-700 rounded-lg hover:bg-green-300">
                    👤 Profil Saya
                </a>
